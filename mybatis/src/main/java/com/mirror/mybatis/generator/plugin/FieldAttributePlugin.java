package com.mirror.mybatis.generator.plugin;
...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.mirror.mybatis.help.DbField");
        root.addImportedType("com.mirror.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.mirror.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.mirror.mybatis.help.FieldResult"));
