...
import { getSupplier, updateSupplier } from '@/services/ant-design-pro/assistCalculateSummary';
import { listRegion } from '@/services/ant-design-pro/system';
import { history } from 'umi';
import { response } from 'express';

const AssistCalculateSupplierDetail: React.FC = (props) => {
    ...
    const onFinish = async (values: any) => {
        ...
        console.log(params);
        await updateSupplier(params).then(response => {
            if (response.data) {
    ...
    return (
        <ProForm
            ...
            request={async (params = {}) => {
                let data = await getSupplier({ id: p.id }).then(response => {
...
export default AssistCalculateSupplierDetail;