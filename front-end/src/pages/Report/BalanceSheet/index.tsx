...
export default () => {
    ...
    const handleSaveBalanceSheetFormula = (record: any) => {
    ...
    const handleDelBalanceSheetFormula = (record: any) => {
        ...
        },
        {
            ...
            render: (text, record, _, action) => (
                <Space>
                    ...
                    {
                        record.liabilitiesType >= 0 && record.rowId === mouseOverRowId ?
                            <Link to='#' onClick={() => {
                                setOpenEditFormula(true);
                                setEditRowName(record.liabilities);
                                setEditRowNo(record.liabilitiesRowNo);
                                onSearchSubject("");
                                formulaRef.current?.reload();
                            }}>编辑公式</Link>
                            : ""
        ...
        <PageContainer>
            ...
            >
                <ProTable<API.ListAccountBookVoItem, API.PageParams>
                    ...
                    toolBarRender={() => [
                        ...
                        <Link key="button" to={"/report/balancesheetprint?reportDate=" + moment(defaultDate).format('YYYY-MM-DD')}
                            target="_blank">
                            打印
                        </Link>
                    ]}
            ...
            <Drawer title={"编辑公式-" + editRowName} placement="right" onClose={onCloseFormula} open={openEditFormula} width={1000}>
                <ProForm
                    ...
                    onFinish={handleSaveBalanceSheetFormula}
