...
export default () => {
    ...
    const handleSaveIncomeStatementFormula = (record: any) => {
    ...
    const handleDelIncomeStatementFormula = (record: any) => {
        ...
        <PageContainer>
            ...
            >
                <ProTable<API.ListAccountBookVoItem, API.PageParams>
                    ...
                    toolBarRender={() => [
                        ...
                        <Link key="button" to={"/report/IncomeStatementPrint?reportDate=" + moment(defaultDate).format('YYYY-MM-DD')}
                            target="_blank">
                            打印
                        </Link>
                    ]}
            ...
            <Drawer title={"编辑公式-" + editRowName} placement="right" onClose={onCloseFormula} open={openEditFormula} width={1000}>
                <ProForm
                    ...
                    onFinish={handleSaveIncomeStatementFormula}
