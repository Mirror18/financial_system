...
import { create, update } from '@/services/ant-design-pro/assistCalculateCate';
import { listRegion } from '@/services/ant-design-pro/system';
import { history } from 'umi';
import { PlusOutlined, DeleteOutlined } from '@ant-design/icons';

const AssistCalculateCateCreate: React.FC = (props) => {
    ...
    const onFinish = async (values: any) => {
        ...
        await create({ code: params.code, name: params.name, customerColumnConfigList: customColumnData }).then(response => {
            if (response.data) {
...
export default AssistCalculateCateCreate;