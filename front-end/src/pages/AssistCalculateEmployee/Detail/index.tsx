...
import { getEmployee, updateEmployee } from '@/services/ant-design-pro/assistCalculateSummary';
import { history } from 'umi';
import { response } from 'express';

const AssistCalculateEmployeeDetail: React.FC = (props) => {
    ...
    const onFinish = async (values: any) => {
        ...
        console.log(params);
        await updateEmployee(params).then(response => {
            if (response.data) {
    ...
    return (
        <ProForm
            ...
            request={async (params = {}) => {
                let data = await getEmployee({ id: p.id }).then(response => {
...
export default AssistCalculateEmployeeDetail;